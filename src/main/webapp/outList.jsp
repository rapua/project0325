...
<body>
	...
	<div>
		...
		<table>
			...
			ResultSet rs = null;
			String sql = "select to_char(a.inoutdate, 'yyy-mm-dd'), a.storecode, b.storename, a.productcode, c.productname, a.gubun, a.saleqty, c.unitprice from inout0325 a, store0325 b, product0325 c where b.storecode = a.storecode and c.productcode = a.productcode and a.gubun>1 order by a.inoutdate, a.storecode, a.productcode desc";
			...
			while (rs.next()) {
				...
				if(q1>=5){
					total4 = (int)(total1 * 0.9);
					total5 = total4+"";
					total6 = total5.replaceAll("\\B(?=(\\d{3})+(?!\\d))", ",");
				}else{
					total4 = total1;
					total5 = total4+"";
					total6 = total5.replaceAll("\\B(?=(\\d{3})+(?!\\d))", ",");
